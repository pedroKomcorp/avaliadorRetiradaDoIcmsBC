...
from src.utils.speds.sped_contrib_dict import get_c100_dict, get_c170_dict, is_c100_valid
from src.utils.docs.results import ExtractionResult
from src.utils.get_selic import GetSelic
...
def extrair_infos(arquivo):
    ...
    try:
        with open(arquivo, 'r', encoding="Latin-1") as file:
            ...
            #caso não, pedir importação de notas
